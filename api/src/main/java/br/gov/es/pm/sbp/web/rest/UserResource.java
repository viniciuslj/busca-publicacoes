...
import br.gov.es.pm.sbp.repository.search.UserSearchRepository;
import br.gov.es.pm.sbp.security.AuthoritiesConstants;
import br.gov.es.pm.sbp.service.MailService;
import br.gov.es.pm.sbp.service.UserService;
import br.gov.es.pm.sbp.service.dto.UserDTO;
import br.gov.es.pm.sbp.web.rest.errors.BadRequestAlertException;
import br.gov.es.pm.sbp.web.rest.errors.EmailAlreadyUsedException;
import br.gov.es.pm.sbp.web.rest.errors.LoginAlreadyUsedException;
